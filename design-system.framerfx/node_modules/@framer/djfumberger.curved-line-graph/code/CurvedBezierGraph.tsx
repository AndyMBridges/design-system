...
export class CurvedLineGraph extends React.Component<Props> {
  ...
  render() {
    return <div style={style} ref={this.containerRef}><canvas ref={this.canvasRef}></canvas></div>;
  }
  ...
  static propertyControls: PropertyControls<Props> = {
    ...
    xOffset: { type: ControlType.Number, title: "X Offset", min: -1000, max: 1000 },
    ...
    labelYOffset: { type: ControlType.Number, title: "Y Offset", min: -50, max: 50,
                    hidden(props) { return props.showYLabels == false } },


    showXLabels: { type: ControlType.Boolean, title: "X Labels" },
              
    labelColor: { type: ControlType.Color, title: "Label Color",
                hidden(props) { return !(props.showXLabels == true || props.showYLabels == true) }  
              },

    showDots: { type: ControlType.Boolean, title: "Show Dots",
              },
    dotSize: { type: ControlType.Number, title: "Dot Size",
               hidden(props) { return props.showDots == false }
              },
...
class CubicCurvedLine {
    ...
    drawPath(ctx: CanvasRenderingContext2D, xScale: number, lineColor: ControlType.Color, lineWidth: number) {
    ...
    drawXLabels(ctx: CanvasRenderingContext2D, labels: string[], labelColor: ControlType.Color, offset: number) {
    ...
    drawYLabels(ctx: CanvasRenderingContext2D, values: string[], labelColor: ControlType.Color, offset: number) {
      ctx.font = "bold 14px SF Pro Display"
      ctx.textAlign = "center"
      ctx.fillStyle = labelColor
      this.dataPoints.forEach( (point, i) => {
    ...
    drawDots(ctx: CanvasRenderingContext2D, dotColor: ControlType.Color, dotSize: number) {
